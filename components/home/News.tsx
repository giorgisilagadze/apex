...
export default function News() {
  return (
    <div className="w-full xl1600:px-[330px] lg1250:px-[200px] lg:px-[100px] sm:px-[64px] px-6 sm:py-[120px] py-[80px] flex flex-col gap-8 bg-blueOpacityLight sm:mt-[-100px] mt-[-60px]">
