    ...
    <div className="w-full ">
      <div className="w-full h-[400px] relative">
        ...
        <div className="w-full px-[330px] absolute top-[50%] translate-y-[-50%] left-0 flex items-center justify-between">
          <h1 className="text-[60px] font-light text-white">პარტნიორები</h1>
          <p className="text-[14px] text-white">მთავარი / პარტნიორები</p>
        </div>
      </div>
      <div className="w-full mt-[100px]">
        <div className="w-full px-[330px] flex flex-col gap-[60px] items-center">
