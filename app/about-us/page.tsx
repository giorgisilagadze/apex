    ...
    <div className="w-full ">
      <div className="w-full h-[400px] relative">
        ...
        <div className="w-full px-[330px] absolute top-[50%] translate-y-[-50%] left-0 flex items-center justify-between">
          <h1 className="text-[60px] font-light text-white">ჩვენ შესახებ</h1>
          <p className="text-[14px] text-white">მთავარი / ჩვენ შესახებ</p>
        </div>
      </div>
      <div className="w-full mt-[100px]">
        <AboutUsComp />
        <div className="w-full grid grid-cols-2 gap-[100px] items-center">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <h1 className="text-[30px] font-semibold">კომპანიის მისია</h1>
            <p className="text-[14px] leading-6 text-grey font-light w-[480px] mt-2">
              ...
              სასურველს კომფორტს.  ამჟამად, აპექს დეველოპმენტი 10 დასრულებულ და
              3 მიმდინარე პროექტს ითვლის თბილისის მასშტაბით.
              სამშენებლო კომპანია აპექს დეველოპმენტი ბაზარზე
               2012 წლიდან ფუნქციონირებს. კომპანია სთავაზობს მომხმარებელს მაღალი
              ხარისხის პროდუქტსა და მომსახურებას და ქმნის თითოეული ინდივიდისთვის
              სასურველს კომფორტს.
        ...
        <div className="w-full px-[330px] py-[60px] bg-[rgba(250,250,250,1)] flex flex-col gap-6 items-center">
          <div className="flex flex-col gap-3 items-center">
            <div className="w-[50px] h-[1px] bg-blue"></div>
            <p className="text-[14px] text-blue font-light">თანამშრომლები</p>
            <h1 className="text-[30px] font-bold mt-[-6px]">ჩვენი გუნდი</h1>
          </div>
          <div className="w-full h-[470px] relative flex items-center gap-10">
            ...
            <Swiper
              ...
              className="w-[calc(100%-144px)] h-full mySwiper rounded-[10px]"
              slidesPerView={4}
            >
